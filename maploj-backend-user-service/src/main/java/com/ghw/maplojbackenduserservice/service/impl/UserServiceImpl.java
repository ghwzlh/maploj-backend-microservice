package com.ghw.maplojbackenduserservice.service.impl;
...
import com.ghw.maplojbackendmodel.model.dto.user.UserQueryRequest;
import com.ghw.maplojbackendmodel.model.entity.User;
import com.ghw.maplojbackendmodel.model.enums.UserRoleEnum;
import com.ghw.maplojbackendmodel.model.vo.LoginUserVO;
import com.ghw.maplojbackendmodel.model.vo.UserVO;
import com.ghw.maplojbackenduserservice.mapper.UserMapper;
...
import static com.ghw.maplojbackendcommon.constant.UserConstant.USER_LOGIN_STATE;
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String userName) {
        ...
        synchronized (userAccount.intern()) {
            ...
            synchronized (userName.intern()) {
                // 账户不能重复
                QueryWrapper<User> newqueryWrapper = new QueryWrapper<>();
                newqueryWrapper.eq("userName", userName);
                long newcount = this.baseMapper.selectCount(newqueryWrapper);
                if (newcount > 0) {
