package com.ghw.maplojbackenduserservice.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.ghw.maplojbackendcommon.annotation.AuthCheck;
import com.ghw.maplojbackendcommon.common.*;
...
import com.ghw.maplojbackendmodel.model.dto.user.*;
import com.ghw.maplojbackendmodel.model.entity.User;
import com.ghw.maplojbackendmodel.model.vo.LoginUserVO;
...
import static com.ghw.maplojbackenduserservice.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> deleteUser(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        User user = this.getUserById(deleteRequest.getId(), request).getData();
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> undeleteUser(@RequestBody unDeleteRequest undeleteRequest, HttpServletRequest request) {
        if (undeleteRequest == null || undeleteRequest.getId() <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        User user = this.getUserById(undeleteRequest.getId(), request).getData();
